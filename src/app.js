            ...
            if (user != null) {
                ...
                if (editorSave == null) {
                    ...
                    if (totalLessons == completedLessons) {
                        ...
                        certDoc.image('./static/img/certificate_background.png', {
                            align: 'center',
                            valign: 'center'
                        })
                        certDoc
                            .registerFont('Metropolis Bold', './static/fonts/Metropolis-Bold.otf')
                            .registerFont('Metropolis', './static/fonts/Metropolis-Regular.otf')

                        s = 'Certificate of Completion'
                        certDoc
                            .font('./static/fonts/FrenchScriptMT-Regular.ttf')
                            .fontSize(82)
                            .fillColor('#804dde')
                        ...
                        certDoc
                            .image('./static/img/certificate_signature.png', (w / 2) - (207 / 2), h * 0.75, {
                                align: 'center'
                            })
                        ...
                        certDoc
                            .opacity(0.75)
                            .image('./static/img/certificate_ix_horiz.png', (w * 0.175) - (230 / 4), h * 0.8, {
                                align: 'center',
                                scale: 0.5
                            })
